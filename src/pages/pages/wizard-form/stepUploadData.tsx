    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            Upload your existing presentation
          </Typography>
          <Typography
            sx={{
              color: '#455A64',
                    ...
                    {selectedFiles && (
                        <ul>
                            {Array.from(selectedFiles).map((file, index) => (
                                <li key={index} style={{color: '#0F0F0F', fontSize: '12px', textAlign: 'start', fontFamily: 'Syne, sans-serif !important;', listStyle: 'none', marginBottom: '20px'}}>
                                    {file.name}
                                    </li>
                            ))}
                        </ul>
