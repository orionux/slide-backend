  ...
  return (
    <CacheProvider value={emotionCache}>
      <Head>
        ...
        <meta
          name='description'
          content={`SLIDE – Material Design React Admin Dashboard Template – is the most developer friendly & highly customizable Admin Dashboard Template based on MUI v5.`}
        />
